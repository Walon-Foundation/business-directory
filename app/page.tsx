import { Search, Shield, Building2, TrendingUp, CheckCircle, Users, Banknote, Globe, ArrowRight, Sparkles, Target, Zap, Lock, BadgeCheck, FileText, LineChart } from 'lucide-react';
        ...
        <div className="relative max-w-6xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-gray-700 mb-10 max-w-2xl mx-auto leading-relaxed px-4 font-light">
              ...
              Real-time data, AI-powered search, and complete transparency for economic growth.
            </p>
                ...
                <div className="relative bg-gradient-to-r from-white to-gray-50 rounded-2xl shadow-2xl border border-gray-200/50 backdrop-blur-sm overflow-hidden">
                  ...
                  <div className="border-t border-gray-100 bg-gradient-to-b from-gray-50/50 to-white/50 p-4">
                    <div className="flex flex-wrap gap-2 justify-center">
                      {['Tech Startups', 'Construction', 'Import/Export', 'Healthcare', 'Agriculture'].map((category) => (
                        <button
                          key={category}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                {/* Card Shadow Effect */}
                <div className={`absolute -inset-0.5 bg-gradient-to-r ${card.gradient} rounded-2xl blur opacity-20 group-hover:opacity-30 transition duration-500`} />
                
                <Card className={`relative ${card.bg} ${card.border} border-2 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group-hover:scale-[1.02]`}>
                  ...
                  <CardContent className="pt-8 pb-6 px-6">
                    <div className="flex items-start justify-between mb-6">
                      <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${card.gradient} p-0.5`}>
                        <div className="w-full h-full bg-white rounded-xl flex items-center justify-center">
                          <card.icon className={`w-6 h-6 bg-gradient-to-r ${card.gradient} bg-clip-text text-transparent`} />
                        </div>
                      </div>
                  ...
                  {/* Hover Effect Line */}
                  <div className={`h-1 bg-gradient-to-r ${card.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-300`} />
                </Card>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <Tabs defaultValue="search" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-12 bg-gradient-to-r from-blue-50 to-cyan-50 p-1 rounded-2xl">
              <TabsTrigger value="search" className="rounded-xl data-[state=active]:bg-white data-[state=active]:shadow-lg">
                <Search className="w-4 h-4 mr-2" />
                Instant Search
              </TabsTrigger>
              <TabsTrigger value="verify" className="rounded-xl data-[state=active]:bg-white data-[state=active]:shadow-lg">
                <Shield className="w-4 h-4 mr-2" />
                Live Verification
              </TabsTrigger>
              <TabsTrigger value="insights" className="rounded-xl data-[state=active]:bg-white data-[state=active]:shadow-lg">
            ...
            <TabsContent value="search" className="mt-0">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <h3 className="text-3xl font-bold mb-4">Lightning-Fast Business Search</h3>
                  <p className="text-gray-600 mb-6">
                    Our intelligent search engine understands partial names, registration numbers, 
                    and even common typos. Get accurate results in milliseconds, not minutes.
                  </p>
                  <ul className="space-y-3 mb-8">
                    {['Fuzzy name matching', 'Registration ID parsing', 'Director name search', 'Location-based filtering'].map((feature, i) => (
                ...
                <Card className="bg-gradient-to-br from-white to-blue-50/50 border-2 border-blue-100 rounded-2xl overflow-hidden shadow-2xl">
                  ...
                  <CardContent className="p-0">
                    <div className="p-6 space-y-4">
                      {['Africell Sierra Leone', 'Sierra Leone Commercial Bank', 'Makeni Agro Processing Ltd'].map((business, i) => (
                        <div key={i} className="p-4 rounded-xl border border-gray-200 hover:border-blue-300 hover:bg-blue-50/50 transition-colors cursor-pointer">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="order-1 md:order-2">
                  <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-100 to-green-100 rounded-full mb-6">
                    ...
                    <span className="text-sm font-semibold text-emerald-700">Bank-Grade Security</span>
                  </div>
                  <h3 className="text-3xl font-bold mb-4">Real-Time Legal Verification</h3>
                  <p className="text-gray-600 mb-6">
                    Direct API integration with government registries ensures you get the most current 
                    business status. No outdated records, no manual verification delays.
                  </p>
