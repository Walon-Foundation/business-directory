import { 
  Building2, Target, Users, Shield, Globe, Award, 
  ArrowRight, CheckCircle, Star, TrendingUp, Heart,
  MapPin, Phone, Mail, Calendar, Sparkles
} from 'lucide-react';
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              Building <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-600">Trust</span> in{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-green-600">Business</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
              We're transforming how businesses are verified in Sierra Leone, creating transparency 
              that fuels economic growth and protects consumers.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="px-8 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700">
                Explore Directory
                <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
              <Button size="lg" variant="outline" className="px-8 border-blue-300">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Verified Business Data</h3>
                    <p className="text-gray-600">
                      Every business in our directory is officially registered and verified with 
                      the Sierra Leone Corporate Affairs Commission.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      We reduce business verification time from weeks to seconds, accelerating 
                      economic transactions and investment.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Empowering consumers to verify businesses before transactions, reducing 
                      fraud and building trust in the marketplace.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl p-8 md:p-12 shadow-2xl shadow-blue-500/20">
                <div className="text-white">
                  ...
                  <h3 className="text-2xl font-bold mb-4">Official Government Partnership</h3>
                  <p className="text-blue-100 mb-6">
                    Working directly with the Corporate Affairs Commission to ensure all 
                    business data is accurate, current, and legally verified.
                  </p>
            ...
            {[
              {
                icon: Shield,
                title: "Integrity",
                description: "We maintain the highest standards of accuracy and reliability in all our data.",
                color: "blue"
              },
              {
                icon: Globe,
                title: "Accessibility",
                description: "Free, open access to verified business information for everyone.",
                color: "cyan"
              },
              {
                icon: Award,
                title: "Excellence",
                description: "Continuous improvement to provide the best verification service.",
                color: "amber"
              },
              {
                icon: Users,
                title: "Collaboration",
                description: "Working with government, businesses, and citizens to build trust.",
                color: "green"
              }
            ].map((value, index) => (
              <Card 
              ...
              >
                <CardHeader>
                  <div className={`w-14 h-14 rounded-xl bg-gradient-to-br from-${value.color}-500 to-${value.color}-600 flex items-center justify-center mb-4`}>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="relative p-8 bg-gradient-to-br from-white to-blue-50/50 rounded-2xl border border-blue-100">
              ...
              <div className="text-center pt-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Reduced Fraud</h3>
                <p className="text-gray-600">
                  Decrease in business-related fraud since verification became accessible
                </p>
              </div>
            </div>
            ...
            <div className="relative p-8 bg-gradient-to-br from-white to-green-50/50 rounded-2xl border border-green-100">
              ...
              <div className="text-center pt-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Faster Verification</h3>
                <p className="text-gray-600">
            ...
            <div className="relative p-8 bg-gradient-to-br from-white to-purple-50/50 rounded-2xl border border-purple-100">
              ...
              <div className="text-center pt-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Monthly Searches</h3>
                <p className="text-gray-600">
