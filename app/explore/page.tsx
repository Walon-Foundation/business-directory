            ...
            <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 p-3 sm:p-4 md:p-6">
              ...
              <div className="mt-3 sm:mt-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
                <div className="flex flex-wrap gap-2">
                  ...
                  >
                    <Shield className={`w-3 h-3 sm:w-4 sm:h-4 mr-1.5 ${showVerifiedOnly ? 'text-green-600' : ''}`} />
                    Verified Only
                    {showVerifiedOnly && <CheckCircle className="w-3 h-3 ml-1.5 text-green-600" />}
                  </Button>
                  <Button variant="outline" size="sm" className="rounded-full text-xs sm:text-sm h-7 sm:h-8">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Switch checked={showVerifiedOnly} onCheckedChange={setShowVerifiedOnly} className="scale-90 sm:scale-100" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
          <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
            <div className="text-xl sm:text-2xl font-bold text-blue-600">{demoCompanies.length}</div>
          ...
          <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="text-xs sm:text-sm text-gray-600">Active Status</div>
          </div>
          <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
          <div>
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Featured Businesses</h2>
        ...
        <div className="mt-8 sm:mt-12 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-blue-200">
          <div className="flex flex-col md:flex-row items-start gap-4 sm:gap-6">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-base sm:text-lg text-gray-900 mb-2">Data Quality & Verification</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3 md:gap-4">
                <div className="flex items-center">
                  ...
                  <span className="text-xs sm:text-sm">✓ Verified - Full due diligence</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 sm:w-3 sm:h-3 bg-amber-500 rounded-full mr-2 sm:mr-3 flex-shrink-0"></div>
                  <span className="text-xs sm:text-sm">⏳ Pending - Under review</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 sm:w-3 sm:h-3 bg-gray-400 rounded-full mr-2 sm:mr-3 flex-shrink-0"></div>
                  <span className="text-xs sm:text-sm">○ Unverified - Basic registration</span>
                </div>
              </div>
            </div>
          </div>
...
function CompanyCard({ company, onViewCompany, onVisitWebsite }: CompanyCardProps) {
  return (
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            <div className="flex items-center bg-amber-50 text-amber-700 px-2 py-1 rounded-md flex-shrink-0">
              ...
              <span className="font-bold text-sm sm:text-base ml-1">{company.rating}</span>
            </div>
          </div>
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="flex flex-wrap gap-1.5 sm:gap-2">
            {company.tags.slice(0, 3).map((tag) => (
              <span key={tag} className="px-2 py-1 text-xs font-medium bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 rounded-full border border-gray-300">
                {tag}
              </span>
            ))}
...
function CompanyRowCard({ company, onViewCompany, onVisitWebsite }: CompanyCardProps) {
  return (
      ...
      <div className="p-3 sm:p-4 md:p-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 mb-1.5 sm:mb-2">
                  ...
                  <div className="flex items-center bg-amber-50 text-amber-700 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-md flex-shrink-0">
                    ...
                    <span className="font-bold text-xs sm:text-sm ml-0.5 sm:ml-1">{company.rating}</span>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 mb-2 sm:mb-3">
                  ...
                  <Badge variant="outline" className="text-xs h-5">{company.industry}</Badge>
                  <Badge variant="outline" className="text-xs h-5">
                    <MapPin className="w-3 h-3 mr-1" />
                    {company.location}
                  </Badge>
                  <span className="text-xs text-gray-500">{company.registrationNumber}</span>
                </div>
                
                <p className="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3 line-clamp-2 leading-relaxed" style={{ 
                  display: '-webkit-box',
                  WebkitLineClamp: 2,
                  WebkitBoxOrient: 'vertical',
                  overflow: 'hidden'
          ...
          <div className="flex flex-col sm:flex-row gap-1.5 sm:gap-2 w-full sm:w-auto mt-2 sm:mt-0">
            <div className={`px-2 py-1 rounded-lg text-xs sm:text-sm font-medium text-center ${
