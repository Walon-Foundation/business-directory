...
import { 
  Building2, MapPin, Users, Calendar, Star, Globe, Mail, Phone, 
  FileText, TrendingUp, Shield, CheckCircle, AlertCircle, ArrowLeft,
  ExternalLink, BarChart, Target, Building, Home, Wallet, Award,
  Briefcase, Users as UsersIcon, CreditCard, FileCheck, Sparkles,
  ChevronRight, Download, Eye, Zap, Heart, Share2, Flag, BuildingIcon
} from 'lucide-react';
...
const detailedCompany = {
  ...
  employees: '500-1000',
  revenue: '$100M+',
  description: 'Leading telecommunications provider in Sierra Leone with nationwide coverage. Africell is committed to connecting communities and driving digital transformation across the country.',
      ...
      <div className="border-b border-gray-200/50 bg-white/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <Link href="/explore" className="inline-flex items-center group text-sm text-gray-600 hover:text-blue-600 transition-colors">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button variant="ghost" size="icon" className="text-gray-500 hover:text-amber-500">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start lg:items-center">
              ...
              <div className="flex items-start gap-4 sm:gap-6">
                ...
                <div className="flex-1">
                  <div className="flex flex-wrap items-center gap-2 mb-3">
                    ...
                    <Badge variant="outline" className="bg-gradient-to-r from-amber-500/5 to-orange-500/5 text-amber-700 border-amber-200/50 backdrop-blur-sm">
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-sm sm:text-base text-gray-600 mb-6">
                    <div className="flex items-center bg-white/50 backdrop-blur-sm px-3 py-1.5 rounded-lg border border-gray-200/50">
                      ...
                      <span className="font-medium">{detailedCompany.location}</span>
                    </div>
                    <div className="flex items-center bg-white/50 backdrop-blur-sm px-3 py-1.5 rounded-lg border border-gray-200/50">
                      <Building className="w-4 h-4 mr-2 text-purple-600" />
                      <span className="font-medium">{detailedCompany.industry}</span>
                    </div>
                    <div className="flex items-center bg-white/50 backdrop-blur-sm px-3 py-1.5 rounded-lg border border-gray-200/50">
                      <Calendar className="w-4 h-4 mr-2 text-amber-600" />
                      <span className="font-medium">Est. {detailedCompany.foundedYear}</span>
                    </div>
                  </div>
            ...
            <div className="flex flex-col sm:flex-row lg:flex-col gap-3 w-full lg:w-64">
              {detailedCompany.website && (
                ...
                >
                  <a href={detailedCompany.website} target="_blank" rel="noopener noreferrer">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card className="border-2 border-blue-100/50 bg-gradient-to-b from-white to-blue-50/30 shadow-lg hover:shadow-xl transition-shadow overflow-hidden">
              ...
              <CardContent className="space-y-5">
                {[
                  { label: 'Registration Number', value: detailedCompany.registrationNumber, icon: CreditCard },
                  { label: 'Business Type', value: detailedCompany.businessType, icon: BuildingIcon },
                  { label: 'Ownership', value: detailedCompany.ownership, icon: UsersIcon },
                  { label: 'Year End', value: detailedCompany.yearEnd, icon: Calendar },
                  { label: 'Tax ID', value: detailedCompany.taxId, icon: Wallet },
                ].map((item, index) => (
            ...
            <Card className="border-2 border-cyan-100/50 bg-gradient-to-b from-white to-cyan-50/30 shadow-lg hover:shadow-xl transition-shadow overflow-hidden">
              ...
              <CardContent className="space-y-5">
                {[
                  ...
                  { label: 'Phone', value: detailedCompany.contactPhone, icon: Phone },
                  { label: 'Email', value: detailedCompany.contactEmail, icon: Mail },
                  { label: 'Address', value: detailedCompany.address, icon: Home },
                ].map((item, index) => (
            ...
            <Card className="border-2 border-green-100/50 bg-gradient-to-b from-white to-green-50/30 shadow-lg hover:shadow-xl transition-shadow overflow-hidden">
              ...
              <CardContent>
                ...
                <div className="space-y-2">
                  <Progress value={detailedCompany.complianceScore} className="h-3 bg-gray-200" />
              ...
              <CardFooter className="pt-0">
                <div className="w-full text-center">
                  <Button variant="ghost" size="sm" className="text-xs text-gray-600 hover:text-green-700">
            ...
            <div className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 backdrop-blur-sm rounded-xl border border-blue-200/50 p-4">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-900">Data Verified & Updated</p>
                  <p className="text-xs text-gray-600">
                    Last updated: {new Date(detailedCompany.lastUpdated).toLocaleDateString('en-US', {
                      year: 'numeric',
                      month: 'long',
                      day: 'numeric'
                    })}
          ...
          <div className="lg:col-span-2">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <Card className="border-2 border-blue-100/50 bg-gradient-to-b from-white to-blue-50/30 shadow-lg overflow-hidden">
                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {[
                        { value: detailedCompany.employees, label: 'Employees', color: 'blue', icon: Users },
                        { value: detailedCompany.revenue, label: 'Annual Revenue', color: 'green', icon: TrendingUp },
                        { value: '14', label: 'Years Operating', color: 'purple', icon: Calendar },
                        { value: '98%', label: 'Service Coverage', color: 'amber', icon: Target },
                      ].map((stat, index) => (
                        <div key={index} className={`relative p-4 rounded-xl bg-gradient-to-br from-${stat.color}-50 to-white border border-${stat.color}-200/50 group hover:scale-[1.02] transition-transform`}>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {detailedCompany.services.map((service, index) => (
                        <div key={index} className="group flex items-center p-3 bg-white/50 backdrop-blur-sm border border-gray-200/50 rounded-lg hover:border-green-300 hover:bg-green-50/30 transition-all">
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-2">
                      {detailedCompany.tags.map((tag, index) => (
                        ...
                        >
                          <span className="text-purple-700 group-hover:text-purple-800">{tag}</span>
                        </Badge>
                      ))}
                    </div>
                  </CardContent>
              ...
              <TabsContent value="financial" className="space-y-6">
                ...
                <Card className="border-2 border-emerald-100/50 bg-gradient-to-b from-white to-emerald-50/30 shadow-lg overflow-hidden">
                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-4">
                      ...
                      <div>
                        <p className="text-sm text-gray-500 mb-1">Financial Summary</p>
                        <p className="text-gray-700 leading-relaxed">{detailedCompany.financialSummary}</p>
                      </div>
                    </div>
                      ...
                      <div className="space-y-3">
                        {[
                          ...
                          <div key={item.year} className="flex items-center group">
                            <span className="w-16 text-sm font-medium text-gray-700">{item.year}</span>
                            ...
                            <div className="w-28 text-right">
                              ...
                              <span className="text-xs text-emerald-600 ml-2">(+{item.growth}%)</span>
                            </div>
                          </div>
                        ))}
                      </div>
                ...
                {/* Subsidiaries Card */}
                {detailedCompany.subsidiaries && detailedCompany.subsidiaries.length > 0 && (
                  <Card className="border-2 border-blue-100/50 bg-gradient-to-b from-white to-blue-50/30 shadow-lg overflow-hidden">
                    <CardHeader>
                      <CardTitle className="flex items-center">
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        {detailedCompany.subsidiaries.map((subsidiary, index) => (
                          <div key={index} className="flex items-center p-4 bg-white/50 backdrop-blur-sm border border-gray-200/50 rounded-xl hover:border-blue-300 hover:bg-blue-50/30 transition-all group">
              ...
              <TabsContent value="operations" className="space-y-6">
                ...
                <Card className="border-2 border-amber-100/50 bg-gradient-to-b from-white to-amber-50/30 shadow-lg overflow-hidden">
                  <CardHeader>
                    ...
                    <CardDescription>Business operations and structure</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {[
                        { label: 'Business Type', value: detailedCompany.businessType, icon: BuildingIcon },
                        { label: 'Ownership Structure', value: detailedCompany.ownership, icon: UsersIcon },
                        { label: 'Year Established', value: detailedCompany.foundedYear, icon: Calendar },
                        { label: 'Primary Location', value: detailedCompany.location, icon: MapPin },
                      ].map((item, index) => (
                        <div key={index} className="p-4 bg-white/50 backdrop-blur-sm border border-amber-200/50 rounded-xl">
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {detailedCompany.certifications.map((cert, index) => (
                        <div key={index} className="group relative overflow-hidden p-4 bg-gradient-to-br from-white to-indigo-50/50 rounded-xl border border-indigo-200/50 hover:border-indigo-300 transition-all">
                          <div className="flex items-center">
              ...
              <TabsContent value="compliance" className="space-y-6">
                ...
                <Card className="border-2 border-green-100/50 bg-gradient-to-b from-white to-green-50/30 shadow-lg overflow-hidden">
                  ...
                  <CardContent className="space-y-4">
                    {[
                      { title: 'Tax Compliance', status: 'Active', description: 'Fully compliant - All taxes paid', score: 95 },
                      { title: 'Business License', status: 'Active', description: 'Valid until December 2024', score: 100 },
                      { title: 'Environmental Compliance', status: 'Active', description: 'All standards met', score: 90 },
                      { title: 'Labor Regulations', status: 'Active', description: 'Compliant with all labor laws', score: 88 },
                    ].map((item, index) => (
                      <div key={index} className="flex items-center justify-between p-4 bg-white/50 backdrop-blur-sm border border-green-200/50 rounded-xl hover:border-green-300 transition-all">
                        <div className="flex items-center">
                          <div className={`w-3 h-3 rounded-full mr-3 ${item.score > 90 ? 'bg-green-500 animate-pulse' : 'bg-amber-500'}`} />
                          <div>
                ...
                {detailedCompany.recentNews && (
                  <Card className="border-2 border-cyan-100/50 bg-gradient-to-b from-white to-cyan-50/30 shadow-lg overflow-hidden">
                    <CardHeader>
                      ...
                      <CardDescription>Latest company developments</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
                        {detailedCompany.recentNews.map((news, index) => (
                          <div key={index} className="group p-4 bg-white/50 backdrop-blur-sm border border-cyan-200/50 rounded-xl hover:border-cyan-300 hover:bg-cyan-50/30 transition-all">
              ...
              <div className="flex flex-col lg:flex-row items-center gap-6">
                ...
                <div className="flex-1 text-center lg:text-left">
                  ...
                  <p className="text-gray-700">
                    This company has been verified by the Sierra Leone Corporate Affairs Commission. 
                    All registration details are current and up-to-date as of {detailedCompany.lastUpdated}.
                  </p>
                </div>
                <Button 
                  variant="outline" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <div className="inline-flex items-center justify-center gap-2 mb-3">
              ...
              <span className="text-sm font-semibold text-gray-900">Official Government Data Source</span>
            </div>
            <p className="text-sm text-gray-600">
              Data provided by Sierra Leone Corporate Affairs Commission • Last verified on{' '}
              {new Date(detailedCompany.lastUpdated).toLocaleDateString('en-US', {
                year: 'numeric',
                month: 'long',
                day: 'numeric'
              })}
            ...
            <p className="text-xs text-gray-500 mt-2">
              For official verification, contact the Corporate Affairs Commission at verification@cac.gov.sl
            </p>
          </div>
        </div>
      </div>
